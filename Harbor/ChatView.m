...
//    self.currentRequest1 = [[ParseManager1 getInstance] retrieveRequestUpdate:self.groupId];
...
//                [chatPrompt pinToTopEdgeOfSuperviewWithOffset:40];
//                [chatPrompt centerHorizontallyInSuperview];
//                [chatPrompt sizeToFit];
//                [chatPrompt sizeToWidth:self.view.frame.size.width - 50];
